...
/**
 * @Description:查询请求绑定公司
 * @Package: cn.inbs.blockchain.controller.company
 * @ClassName:
 * @Date: 2018年05月29-10:25
 * @Author: createBy:zhangmingyang
 **/
@Controller
@RequestMapping(value = "/company")
public class QueryRequisitionRelatedCompanyController extends BaseController {
    private static Logger logger = LoggerFactory.getLogger(QueryRequisitionRelatedCompanyController.class);

    private static final String USER_ID = "userId";
    @Resource
    private IBlockCompanyService blockCompanyService;

    @RequestMapping(value = "/queryRequisitionRelated.do", method = RequestMethod.POST, produces = "text/json;charset=UTF-8")
    @ResponseBody
    public String queryRequisitionRelated(HttpServletRequest httpServletRequest) {
        PagePo pagePo = blockCompanyService.queryRequisitionRelated(checkParam(httpServletRequest), Long.valueOf(httpServletRequest.getParameter(USER_ID)));
