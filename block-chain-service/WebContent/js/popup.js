...
Popup.prototype = {iframeIdName:"ifr_popup", initialize:function (config) {
	...
	this.color = {cColor:"#000000", bColor:"#FFFFFF", tColor:"#3753A4", wColor:"#FFFFFF"};
	this.dropClass = null;
	this.someToHidden = [];
	...
	var path = "/image/dialogclose.gif";
		var close = "<input style=\"font-size:14px; text-align:center; padding:0 4px;\" type=\"button\" id=\"dialogBoxClose\" value=\"X\" src=\"\" border=\"0\" width=\"24\" height=\"24\" align=\"absmiddle\" title=\"\u5173\u95ed\"/>";
	...
	if (this.config.isHaveTitle) {
		mainBox += "<tr height=\"24\" bgcolor=\"" + this.color.tColor + "\"><td><table style=\"-moz-user-select:none;height:24px;\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" ><tr>" + "<td id=\"dialogBoxTitle\" style=\"color:" + this.color.wColor + ";font-size:14px;font-weight:bold;\">" + this.info.title + "&nbsp;</td>" + "<td id=\"dialogClose\" width=\"20\" align=\"right\" valign=\"middle\">" + close + "</td></tr></table></td></tr>";
	} else {
		mainBox += "<tr height=\"10\"><td align=\"right\">" + close + "</td></tr>";
	}
	mainBox += "<tr style=\"height:" + this.config.height + "px\" valign=\"top\"><td id=\"dialogBody\" style=\"position:relative;margin:0; padding:0;\"></td></tr></table></div>" + "<div id=\"dialogBoxShadow\" style=\"display:none;z-index:" + baseZIndex + ";\"></div>";
